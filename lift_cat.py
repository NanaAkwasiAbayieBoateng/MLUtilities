...
target label.
lift_cat(Data=data, feature = 'sepal_length',target='target')
...
def lift_cat(Data,feature,target):
    ...
    d3.rename(columns={'target_x': 'target_pos', 'target_y': 'target_neg','target_percent':'neg_percent'}, inplace=True)
    return d3
